...
func findCombination(digits *string, index int, s string) {
	...
	num := (*digits)[index]      // "29" = 50 57
	letter := letterMap[num-'0'] // 50 - '0' = 2 57 - '0' = 9 ;abc wxyz
...
func Test_letterCombinations(t *testing.T) {
	fmt.Println(letterCombinations("29")) // [aw ax ay az bw bx by bz cw cx cy cz]
}
